        ...
        <Form
          ...
          fields={[
            ...
            },
            {
              name: 'floor-radio',
              label: 'Verdieping',
              help: 'Wel verdieping wilt u?',
              type: 'radio',
              disabled: true,
              filter: true,
              placeholder: 'Omschrijving',
              options: [
                {value: 1, desc: 'Verdieping 1'},
                {value: 2, desc: 'Verdieping 2'},
                {value: 3, desc: 'Verdieping 3'},
                {value: 4, desc: 'Verdieping 4'}
              ],
              labelSize: {md: 4},
              fieldSize: {md: 8}
            },
            ...
            {
              name: 'show_on_value_7',
              label: 'Verberg op verdieping 4 en Kamernummer 5',
              type: 'text',
              hidden: () => ([
                {
                  field: 'floor-radio',
            ...
            },
            {
              ...
              label: 'Toon op checkbox value NIET 1',
              type: 'text',
              hidden: () => ({
                field: 'room-checkbox',
                value_not: 1,
            ...
            },
            {
              ...
              label: 'Toon op checkbox value 2,3',
              type: 'text',
              show: () => ({
                field: 'room-checkbox',
                value: [2, 3],
            ...
            {
              name: 'show_on_value_3',
              label: 'Verberg op checkbox value 4 OF 5',
              type: 'text',
              show: () => ({
                field: 'room-checkbox',
                value_not: [4, 5],
            ...
            {
              name: 'show_on_value_4',
              label: 'Verberg op checkbox value 4 EN 5',
              type: 'text',
              show: () => ({
                field: 'room-checkbox',
                value_not: [4, 5],
