...
module.exports = {
  ...
  entry: {
    ...
    'vendor': ['redux', 'redux-form-generator', 'react-helmet', 'react-bootstrap', 'react-bootstrap-datetimepicker', 'react', 'react-dom', 'classnames', 'history', 'scroll-behavior', 'moment', 'lodash', 'react-router', 'history'],
  },
  output: {
    path: assetsPath,
