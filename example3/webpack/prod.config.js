  ...
  entry: {
    'main': [
     /* 'bootstrap-sass!./src/theme/bootstrap.config.prod.js',
      ...
      './src/theme/boss/css/style.css',*/
      './src/client.js'
    ],
    'vendor': ['redux', 'redux-form-generator', 'react-helmet', 'react-bootstrap', 'react-bootstrap-datetimepicker', 'react-chartjs', 'react-copy-to-clipboard', 'react', 'react-dom', 'chart.js', 'classnames', 'history', 'scroll-behavior', 'moment', 'lodash', 'react-router', 'history'],
  },
  output: {
    path: assetsPath,
