  ...
  _createClass(BaseForm, [{
    ...
    value: function addField(field, size) {
      ...
      if (!_lodash2['default'].isEmpty(field)) {
        ...
        switch (field.type) {
          case 'submit':
            return _react2['default'].createElement(_types.GenSubmit, { 'static': this.props['static'], key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'button':
            return _react2['default'].createElement(_types.GenButton, { 'static': this.props['static'], key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'dropdown':
            return _react2['default'].createElement(_types.GenDropDown, { 'static': this.props['static'], submit: this.submitForm, formName: this.props.formName,
          ...
          case 'success':
          case 'error':
            return _react2['default'].createElement(_types.GenMessage, { 'static': this.props['static'], key: field.type, displayErrors: this.state.displayErrors,
          ...
          case 'file':
            return _react2['default'].createElement(_types.GenFile, { 'static': this.props['static'], key: field.name, field: field, size: size, properties: properties,
              addField: this.addField });
          case 'static':
            return _react2['default'].createElement(_types.GenStatic, { 'static': this.props['static'], key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'plupload':
            return _react2['default'].createElement(_types.GenPlupload, { 'static': this.props['static'], key: field.name, field: field, formKey: this.props.formKey,
          ...
          case 'radio':
            return _react2['default'].createElement(_types.GenRadio, { 'static': this.props['static'], key: field.name, field: field, size: size, properties: properties,
              addField: this.addField });
          case 'checkboxList':
            return _react2['default'].createElement(_types.GenCheckboxList, { 'static': this.props['static'], formName: this.props.formName, formKey: this.props.formKey,
              dispatch: this.props.dispatch, key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'checkboxListiOs':
            return _react2['default'].createElement(_types.GenCheckboxListiOs, { 'static': this.props['static'], formName: this.props.formName,
          ...
          case 'resource':
            return _react2['default'].createElement(_types.GenResource, { 'static': this.props['static'], formName: this.props.formName, formKey: this.props.formKey,
              dispatch: this.props.dispatch, key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'rte':
            return _react2['default'].createElement(_types.GenRte, { 'static': this.props['static'], dispatch: this.props.dispatch, key: field.name, field: field,
              size: size, properties: properties, addField: this.addField, formName: this.props.formName,
              formKey: this.props.formKey });
          case 'dateTime':
            return _react2['default'].createElement(_types.GenDateTime, { 'static': this.props['static'], key: field.name, field: field, size: size,
              properties: properties, addField: this.addField });
          case 'react':
            return field.component();
          default:
            return _react2['default'].createElement(_types.GenInput, { 'static': this.props['static'], key: field.name, field: field, size: size, properties: properties,
              addField: this.addField });
        }
      }
    }
