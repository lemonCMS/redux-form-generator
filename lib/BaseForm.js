...
var BaseForm = (function (_Component) {
  ...
  BaseForm.prototype.componentWillMount = function componentWillMount() {
  ...
  BaseForm.prototype.tabs = function tabs(field, key, size) {
    var _this = this;
  ...
  BaseForm.prototype.tab = function tab(tabs, size) {
    var _this2 = this;
