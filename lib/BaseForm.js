  ...
  BaseForm.prototype.addField = function addField(field, size) {
    ...
    if (!_lodash2['default'].isEmpty(field)) {
      ...
      switch (field.type) {
        ...
        case 'success':
        case 'error':
          return _react2['default'].createElement(_types.GenMessage, { 'static': this.props['static'], key: field.type, field: field, size: size, properties: properties, valid: this.props.valid, invalid: this.props.invalid, pristine: this.props.pristine, getActionState: this.props.getActionState }); // return this.message(field, size);
        case 'file':
