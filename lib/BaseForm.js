  ...
  BaseForm.prototype.addField = function addField(field, size) {
    if (!_lodash2['default'].isEmpty(field)) {
      ...
      switch (field.type) {
        ...
        default:
          return _react2['default'].createElement(_types.GenInput, { key: field.name, field: field, size: size, properties: properties, addField: this.addField }); // inputType.input(field, size);
      }
    }
  };
