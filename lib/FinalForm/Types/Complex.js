(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "lodash/clone", "lodash/get", "lodash/has", "react", "react-final-form-arrays", "react-bootstrap/lib/Panel", "react-bootstrap/lib/Button", "react-bootstrap/lib/Row", "react-bootstrap/lib/Col", "react-bootstrap/lib/ButtonToolbar", "react-bootstrap/lib/ControlLabel", "lodash/isFunction"], factory);
    ...
    factory(mod.exports, global.propTypes, global.clone, global.get, global.has, global.react, global.reactFinalFormArrays, global.Panel, global.Button, global.Row, global.Col, global.ButtonToolbar, global.ControlLabel, global.isFunction);
    global.Complex = mod.exports;
  }
})(this, function (_exports, _propTypes, _clone2, _get3, _has2, _react, _reactFinalFormArrays, _Panel, _Button, _Row, _Col, _ButtonToolbar, _ControlLabel, _isFunction2) {
  "use strict";
  ...
  var _jsxFileName = "example/app/components/Form/FinalForm/Types/Complex.jsx";
  ...
  function (_React$Component) {
    ...
    _proto.renderChildren = function renderChildren(children, name, count, remove, move, complexIndex, removeBtn, size, staticField, disabled) {
      ...
      }, _react.default.createElement(_ButtonToolbar.default, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 77
        }
      ...
      }, _react.default.createElement(_Panel.default.Heading, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 85
        }
      }, headerDiv), _react.default.createElement(_Panel.default.Body, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 88
        }
      ...
      })), footer && _react.default.createElement(_Panel.default.Footer, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 96
        }
    ...
    _proto.renderComplex = function renderComplex(props) {
      ...
      var renderAddButton = function renderAddButton() {
        if ((0, _get3.default)(_this3.props.field, 'multiple', true) === true || fields.length === 0) {
          ...
          }), (0, _get3.default)(addBtn, 'label', locale.complex.buttonAdd)), touched && error && _react.default.createElement("span", {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 178
            }
      ...
      }), '- ', label)), _react.default.createElement(_Col.default, _extends({}, fieldSize(), {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 192
        }
