(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "lodash/omit", "prop-types", "lodash/get", "lodash/has", "lodash/uniq", "lodash/map", "lodash/indexOf", "lodash/clone", "lodash/isEmpty", "react", "react-final-form", "react-bootstrap/lib/Button", "react-bootstrap/lib/FormGroup", "react-bootstrap/lib/FormControl", "react-bootstrap/lib/Col", "react-bootstrap/lib/ControlLabel", "react-bootstrap/lib/HelpBlock", "lodash/isFunction"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("lodash/omit"), require("prop-types"), require("lodash/get"), require("lodash/has"), require("lodash/uniq"), require("lodash/map"), require("lodash/indexOf"), require("lodash/clone"), require("lodash/isEmpty"), require("react"), require("react-final-form"), require("react-bootstrap/lib/Button"), require("react-bootstrap/lib/FormGroup"), require("react-bootstrap/lib/FormControl"), require("react-bootstrap/lib/Col"), require("react-bootstrap/lib/ControlLabel"), require("react-bootstrap/lib/HelpBlock"), require("lodash/isFunction"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.omit, global.propTypes, global.get, global.has, global.uniq, global.map, global.indexOf, global.clone, global.isEmpty, global.react, global.reactFinalForm, global.Button, global.FormGroup, global.FormControl, global.Col, global.ControlLabel, global.HelpBlock, global.isFunction);
    global.Resource = mod.exports;
  }
})(this, function (_exports, _omit2, _propTypes, _get2, _has2, _uniq2, _map2, _indexOf2, _clone2, _isEmpty2, _react, _reactFinalForm, _Button, _FormGroup, _FormControl, _Col, _ControlLabel, _HelpBlock, _isFunction2) {
  "use strict";
  ...
  function (_React$Component) {
    ...
    _proto.options = function options() {
      ...
      var options = (0, _map2["default"])(this.state.list || (0, _get2["default"])(field, 'list', []), function (option, key) {
    ...
    _proto.renderField = function renderField(props) {
      ...
      }), getLabel(), _react["default"].createElement(_Col["default"], fieldSize(), component(), touched && (submitError || error) && _react["default"].createElement(_FormControl["default"].Feedback, null), help && (!touched || !submitError && !error) && _react["default"].createElement(_HelpBlock["default"], null, help), touched && (submitError || error) && _react["default"].createElement(_HelpBlock["default"], null, submitError || error)));
    };
