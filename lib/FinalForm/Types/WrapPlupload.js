(function (global, factory) {
  ...
  var _jsxFileName = "example/app/components/Form/FinalForm/Types/WrapPlupload.jsx";
    ...
    _proto.renderField = function renderField(props) {
      ...
      var editRender = function editRender(files) {
        if (files.length > 0) {
          return _react.default.createElement(_Table.default, {
          ...
          }, "Bestand"), _react.default.createElement("th", {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 100
            }
          ...
          }, (0, _map2.default)(input.value, function (file, key) {
            ...
            }, file.file_original_name, " ", file.deleted), _react.default.createElement("td", {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 107
              }
      ...
      var staticRender = function staticRender(files) {
        if (files.length > 0) {
          return _react.default.createElement(_Table.default, {
          ...
          }, "Bestand"))), _react.default.createElement("tbody", {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 131
            }
          }, (0, _map2.default)(files, function (file, key) {
            return !file.deleted && _react.default.createElement("tr", {
              key: key,
              __source: {
                fileName: _jsxFileName,
            ...
            }, file.file_original_name, " ", file.deleted));
          })));
        }
      };
      ...
      var component = function component() {
        ...
        if (staticField === false) {
          ...
          }, _react.default.createElement(_reactPlupload.default, _extends({
            key: input.name
          }, custom.conf, {
      ...
      }), component(), renderTable(), (touched && error || submitFailed && submitError) && _react.default.createElement(_FormControl.default.Feedback, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 227
        }
