...
var _TinyMceInput = require('../../Modules/TinyMceInput');
...
var WrapRte = function (_React$Component) {
  ...
  _createClass(WrapRte, [{
    ...
    value: function renderField(props) {
      ...
      var add = (0, _pick3.default)(custom, ['placeholder', 'rows', 'cols', 'id']);
      ...
      var component = function component() {
        ...
        return _react2.default.createElement(_TinyMceInput2.default, _extends({
          value: input.value
        }, add, {
