(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    function ContextWrapper(props, context) {
      ...
      _this.checkDisabled = _this.checkDisabled.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.checker = _this.checker.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.checkHidden = _this.checkHidden.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.checkShow = _this.checkShow.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      return _this;
    }
