(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
      ...
      if (!(0, _isEqual2.default)((0, _omit2.default)(nextProps.initialValues, ['pending', 'success', 'failed']), (0, _omit2.default)(this.props.initialValues, ['pending', 'success', 'failed']))) {
        return true;
      }

      if (!(0, _isEqual2.default)(nextProps.fields, this.props.fields)) {
        return true;
      }

      return (0, _get2.default)(this.props, 'static', false) !== (0, _get2.default)(nextProps, 'static', false);
    };
