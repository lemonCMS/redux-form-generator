(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
      ...
      if (!(0, _fastEquals.deepEqual)((0, _omit2["default"])(nextProps.initialValues, ['pending', 'success', 'failed', 'actionStatus']), (0, _omit2["default"])(this.props.initialValues, ['pending', 'success', 'failed', 'actionStatus']))) {
        this.updateCounter += 1;
      ...
      if (!(0, _fastEquals.deepEqual)(nextProps.fields, this.props.fields)) {
        this.updateCounter += 1;
