(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "lodash/get", "lodash/has", "lodash/clone", "lodash/isEmpty", "lodash/filter", "lodash/map", "lodash/omit", "lodash/isUndefined", "fast-equals", "lodash/isBoolean", "lodash/isString", "lodash/isArray", "lodash/isObject", "lodash/pick", "lodash/isFunction", "react-bootstrap/lib/Form", "react-bootstrap/lib/Row", "react-bootstrap/lib/Col", "react-bootstrap/lib/ButtonToolbar", "react-redux", "redux-form", "./Types/Input", "./Types/Plupload", "./Types/Checkbox", "./Types/DateTime", "./Types/Radio", "./Types/Select", "./Types/Button", "./Types/Rte", "./Types/Resource", "./Types/Message", "./Types/Complex", "./Types/Plain", "./Types/ContentEditable", "./locales", "./Pending"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("lodash/get"), require("lodash/has"), require("lodash/clone"), require("lodash/isEmpty"), require("lodash/filter"), require("lodash/map"), require("lodash/omit"), require("lodash/isUndefined"), require("fast-equals"), require("lodash/isBoolean"), require("lodash/isString"), require("lodash/isArray"), require("lodash/isObject"), require("lodash/pick"), require("lodash/isFunction"), require("react-bootstrap/lib/Form"), require("react-bootstrap/lib/Row"), require("react-bootstrap/lib/Col"), require("react-bootstrap/lib/ButtonToolbar"), require("react-redux"), require("redux-form"), require("./Types/Input"), require("./Types/Plupload"), require("./Types/Checkbox"), require("./Types/DateTime"), require("./Types/Radio"), require("./Types/Select"), require("./Types/Button"), require("./Types/Rte"), require("./Types/Resource"), require("./Types/Message"), require("./Types/Complex"), require("./Types/Plain"), require("./Types/ContentEditable"), require("./locales"), require("./Pending"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.get, global.has, global.clone, global.isEmpty, global.filter, global.map, global.omit, global.isUndefined, global.fastEquals, global.isBoolean, global.isString, global.isArray, global.isObject, global.pick, global.isFunction, global.Form, global.Row, global.Col, global.ButtonToolbar, global.reactRedux, global.reduxForm, global.Input, global.Plupload, global.Checkbox, global.DateTime, global.Radio, global.Select, global.Button, global.Rte, global.Resource, global.Message, global.Complex, global.Plain, global.ContentEditable, global.locales, global.Pending);
    global.Form = mod.exports;
  }
})(this, function (_exports, _propTypes, _react, _get2, _has2, _clone2, _isEmpty2, _filter2, _map2, _omit2, _isUndefined2, _fastEquals, _isBoolean2, _isString2, _isArray2, _isObject2, _pick2, _isFunction2, _Form, _Row, _Col, _ButtonToolbar, _reactRedux, _reduxForm, _Input, _Plupload, _Checkbox, _DateTime, _Radio, _Select, _Button, _Rte, _Resource, _Message, _Complex, _Plain, _ContentEditable, _locales, _Pending) {
  "use strict";
  ...
  function (_React$Component) {
    ...
    _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
      ...
      if (!(0, _fastEquals.shallowEqual)((0, _omit2["default"])(nextProps.initialValues, ['pending', 'success', 'failed', 'actionStatus']), (0, _omit2["default"])(this.props.initialValues, ['pending', 'success', 'failed', 'actionStatus']))) {
        this.updateCounter += 1;
      ...
      if (!(0, _fastEquals.shallowEqual)(nextProps.fields, this.props.fields)) {
        this.updateCounter += 1;
