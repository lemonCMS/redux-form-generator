(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
      ...
      if (!deepEqual((0, _omit2["default"])(nextProps.initialValues, ['pending', 'success', 'failed', 'actionStatus']), (0, _omit2["default"])(this.props.initialValues, ['pending', 'success', 'failed', 'actionStatus']))) {
        this.updateCounter += 1;
