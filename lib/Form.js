...
var InnerForm = function InnerForm(props) {
  ...
  var addField = function addField(field, key, size) {
    ...
    switch (field.type) {
      ...
      case 'plain':
        return _react3.default.createElement(_Plain2.default, { key: key, field: field, size: size });
      case 'jsx':
      case 'react':
      ...
      default:
        return _react3.default.createElement(_Input2.default, { checkDisabled: checkDisabled, locale: locale, key: key, field: field, size: size, addField: addField, 'static': props.static });
    }
  };
...
RenderForm.propTypes = {
  ...
  'updateOn': _react3.default.PropTypes.array,
