...
var InnerForm = function InnerForm(props) {
  ...
  var addField = function addField(field, key, size) {
    ...
    switch (field.type) {
      case 'resource':
        return _react3.default.createElement(_Resource2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'checkbox':
        return _react3.default.createElement(_Checkbox2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'plupload':
        return _react3.default.createElement(_Plupload2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'select':
        return _react3.default.createElement(_Select2.default, { locale: locale, key: key, field: field, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'radio':
        return _react3.default.createElement(_Radio2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'contentEditable':
        return _react3.default.createElement(_ContentEditable2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'complex':
        return _react3.default.createElement(_Complex2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, addField: addField, formName: props.name, 'static': props.static, horizontal: props.horizontal });
      case 'submit':
      case 'button':
        return _react3.default.createElement(_Button2.default, { locale: locale, key: key, field: field, dispatch: props.dispatch, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'rte':
        return _react3.default.createElement(_Rte2.default, { locale: locale, key: key, field: field, size: size, 'static': props.static, horizontal: props.horizontal });
      case 'plain':
        return _react3.default.createElement(_Plain2.default, { key: key, field: field, size: size, horizontal: props.horizontal });
      case 'jsx':
      case 'react':
      ...
      case 'datetime':
        return _react3.default.createElement(_DateTime2.default, { locale: locale, key: key, field: field, size: size, 'static': props.static, horizontal: props.horizontal });
      default:
        return _react3.default.createElement(_Input2.default, { checkDisabled: checkDisabled, locale: locale, key: key, field: field, size: size, addField: addField, 'static': props.static, horizontal: props.horizontal });
    }
  };
...
RenderForm.propTypes = {
  ...
  'validate': _react3.default.PropTypes.func,
