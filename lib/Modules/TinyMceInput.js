...
var TinyMCEInput = function (_React$Component) {
  ...
  function TinyMCEInput() {
    ...
    _this.displayName = 'TinyMCEInput';
  ...
  _createClass(TinyMCEInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'hidden', name: this.props.name, value: this.state.value, readOnly: true }),
        _react2.default.createElement(Component
        // id={this.state.id}
        , _extends({ defaultValue: this.state.value,
