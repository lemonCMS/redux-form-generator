...
var Complex = _wrapComponent('Complex')(function (_React$Component) {
  ...
  (0, _createClass3.default)(Complex, [{
    key: 'renderChildren',
    value: function renderChildren(children, name, count, remove, move, complexIndex, removeBtn, size, staticField) {
      var _this2 = this;
    ...
    value: function renderComplex(props) {
      ...
      var toggle = function toggle() {
        var state = false;
        if (_this3.state.collapsed === false) {
          state = true;
        }
        var complexName = name + '_collapsed';
        ...
        _react3.default.createElement(
          ...
          fields.map(function (field, key) {
            return _react3.default.createElement(
              ...
              _this3.renderChildren(children, field, fields.length, fields.remove, fields.move, key, removeBtn, size, staticField)
            );
          }),
          _react3.default.createElement(
            'div',
            ...
            staticField !== true && _react3.default.createElement(
              ...
              { type: 'button',
                ...
                className: 'btn ' + (0, _get4.default)(this.props.field.addBtn, 'className', 'btn-default')
              },
              addBtn.label
            ),
