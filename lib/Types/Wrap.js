    ...
    _proto.renderField = function renderField(props) {
      ...
      var buttonAfter = function buttonAfter() {
        if ((0, _has2.default)(_this3.props.field, 'buttonAfter')) {
          if (_this3.props.field.buttonAfter.type) {
      ...
      }), getLabel(), _react.default.createElement(_Col.default, fieldSize(), getField(), touched && error && _react.default.createElement(_FormControl.default.Feedback, null), help && (!touched || !error) && _react.default.createElement(_HelpBlock.default, null, help), touched && error && _react.default.createElement(_HelpBlock.default, null, error)));
    };
