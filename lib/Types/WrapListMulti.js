...
var WrapListMulti = function (_React$Component) {
  _inherits(WrapListMulti, _React$Component);

  function WrapListMulti() {
    _classCallCheck(this, WrapListMulti);

    var _this = _possibleConstructorReturn(this, (WrapListMulti.__proto__ || Object.getPrototypeOf(WrapListMulti)).call(this));
      ...
      return (0, _map3.default)(list, function (option, key) {
        ...
        return _react2.default.createElement(
          _Checkbox2.default,
          {
            ...
            onChange: function onChange(event) {
              var newValue = [].concat(_toConsumableArray(_this3.input.value));
              if (event.target.checked) {
...
//# sourceMappingURL=WrapListMulti.js.map