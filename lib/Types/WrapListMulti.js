(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    function WrapListMulti() {
      ...
      _this.handlePrevent = _this.handlePrevent.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _proto.filtered = function filtered(options) {
      ...
      if (this.props.static === true || (0, _get2.default)(this.props.field, 'static', false) === true) {
        return (0, _filter2.default)(options, function (option) {
          if ((0, _get2.default)(_this2.props, 'field.single', false) === true) {
            return String(_this2.input.value) === String(option.value);
          }
    ...
    _proto.renderField = function renderField(props) {
      ...
      }), this.searchBox(), this.radioButtons(), touched && error && _react.default.createElement(_FormControl.default.Feedback, null), help && (!touched || !error) && _react.default.createElement(_HelpBlock.default, null, help), touched && error && _react.default.createElement(_HelpBlock.default, null, error)));
    };
