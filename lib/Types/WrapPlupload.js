(function (global, factory) {
  ...
  function (_React$Component) {
    ...
    _proto.renderField = function renderField(props) {
      ...
      }), getLabel(), _react.default.createElement(_Col.default, fieldSize(), component(), renderTable(), touched && error && _react.default.createElement(_FormControl.default.Feedback, null), help && (!touched || !error) && _react.default.createElement(_HelpBlock.default, null, help), touched && error && _react.default.createElement(_HelpBlock.default, null, error)));
    };
