    ...
    value: function renderField(props) {
      ...
      var fileUploaded = function fileUploaded(plupload, file, response) {
        ...
        if ((0, _get3.default)(custom, 'multi_selection', true) === false) {
          _this2.setState({ allFiles: [uploadResponse.result], changed: Date.now() }, function () {
            _this2.input.onChange(_this2.state.allFiles);
          });
        } else {
          var files = (0, _clone3.default)(_this2.state.allFiles);
          files.push(uploadResponse.result);
          _this2.setState({ allFiles: files, changed: Date.now() }, function () {
            _this2.input.onBlur();
            _this2.input.onChange(_this2.state.allFiles);
          });
        }
      ...
      var renderTable = function renderTable() {
        var files = (0, _filter3.default)(input.value, function (file) {
          return !file.deleted;
        });
        if (files.length > 0) {
          return _react3.default.createElement(
      ...
      var component = function component() {
        var staticField = _this2.props.static || (0, _get3.default)(_this2.props.field, 'static', false);
...
WrapPlupload.propTypes = {
  ...
  'input': _react3.default.PropTypes.object,
