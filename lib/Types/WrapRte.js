(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "lodash/has", "lodash/get", "lodash/pick", "lodash/isFunction", "react-tinymce-input", "react-bootstrap/lib/Col", "react-bootstrap/lib/FormControl", "react-bootstrap/lib/FormGroup", "react-bootstrap/lib/ControlLabel", "react-bootstrap/lib/HelpBlock"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("lodash/has"), require("lodash/get"), require("lodash/pick"), require("lodash/isFunction"), require("react-tinymce-input"), require("react-bootstrap/lib/Col"), require("react-bootstrap/lib/FormControl"), require("react-bootstrap/lib/FormGroup"), require("react-bootstrap/lib/ControlLabel"), require("react-bootstrap/lib/HelpBlock"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.has, global.get, global.pick, global.isFunction, global.reactTinymceInput, global.Col, global.FormControl, global.FormGroup, global.ControlLabel, global.HelpBlock);
    global.WrapRte = mod.exports;
  }
})(this, function (_exports, _propTypes, _react, _has2, _get2, _pick2, _isFunction2, _reactTinymceInput, _Col, _FormControl, _FormGroup, _ControlLabel, _HelpBlock) {
  "use strict";
  ...
  _reactTinymceInput = _interopRequireDefault(_reactTinymceInput);
  ...
  function (_React$Component) {
    ...
    _proto.renderField = function renderField(props) {
      ...
      var component = function component() {
        ...
        return _react.default.createElement(_reactTinymceInput.default, _extends({
          value: input.value
        }, add, {
      ...
      }), component(), touched && error && _react.default.createElement(_FormControl.default.Feedback, null), help && (!touched || !error) && _react.default.createElement(_HelpBlock.default, null, help), touched && error && _react.default.createElement(_HelpBlock.default, null, error)));
    };
