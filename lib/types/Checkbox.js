...
var _components = {
  CheckboxType: {
    displayName: 'CheckboxType'
  }
};

var _reactTransformCatchErrors2 = (0, _reactTransformCatchErrors4.default)({
  filename: 'src/types/Checkbox.js',
...
var CheckboxType = _wrapComponent('CheckboxType')((_dec = (0, _Wrap2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(CheckboxType, _Component);

  function CheckboxType() {
    (0, _classCallCheck3.default)(this, CheckboxType);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CheckboxType.__proto__ || (0, _getPrototypeOf2.default)(CheckboxType)).call(this));
  ...
  (0, _createClass3.default)(CheckboxType, [{
    ...
    value: function onChange(e) {
      ...
      if (e.target.checked === true) {
        ...
        values.splice(_lodash2.default.indexOf(values, e.target.value), 1);
      }
    ...
    value: function radioButtons() {
      ...
      var selectedValue = _lodash2.default.get(this.props.properties, 'value') || _lodash2.default.get(this.props.properties, 'initialValue');
      if (!_lodash2.default.isArray(selectedValue)) {
          ...
          var chunks = function chunks() {
            ...
            return _lodash2.default.map(chunkData, function (chunk, key) {
              return _react3.default.createElement(
                ...
                _this3.radioButtonList(chunk, _this3.state.selected)
              );
            });
          };
          return {
      ...
      return _lodash2.default.map(filtered, function (option, key) {
        return _react3.default.createElement(
          _reactBootstrap.Checkbox,
          {
            ...
            checked: _this3.state.selected.indexOf(String(option.value)) > -1
          },
          option.desc
        );
      });
    ...
    value: function getValue() {
      ...
      return _lodash2.default.map(value, function (val, key) {
        return _react3.default.createElement(
          'span',
          { key: key },
          _react3.default.createElement('i', { className: 'fa fa-check-square-o' }),
          ' ',
          _lodash2.default.get(options, [_lodash2.default.findIndex(options, ['value', val]), 'desc'], ''),
