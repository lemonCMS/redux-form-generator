...
var ResourceNode = _wrapComponent('ResourceNode')((_dec = (0, _Wrap2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(ResourceNode, _Component);

  function ResourceNode() {
    (0, _classCallCheck3.default)(this, ResourceNode);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ResourceNode.__proto__ || (0, _getPrototypeOf2.default)(ResourceNode)).call(this));
  ...
  (0, _createClass3.default)(ResourceNode, [{
    key: 'onChange',
