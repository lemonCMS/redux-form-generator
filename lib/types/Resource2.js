...
var _components = {
  ResourceNode2: {
    displayName: 'ResourceNode2'
  }
};

var _reactTransformCatchErrors2 = (0, _reactTransformCatchErrors4.default)({
  filename: 'src/types/Resource2.js',
...
var ResourceNode2 = _wrapComponent('ResourceNode2')((_dec = (0, _Wrap2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(ResourceNode2, _Component);

  function ResourceNode2() {
    (0, _classCallCheck3.default)(this, ResourceNode2);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ResourceNode2.__proto__ || (0, _getPrototypeOf2.default)(ResourceNode2)).call(this));
  ...
  (0, _createClass3.default)(ResourceNode2, [{
    key: 'onChange',
    ...
    value: function render() {
      ...
      var selectedValue = properties.value || properties.initialValue || [];

      var button = function button() {
        if (!_this3.props.static) {
          return _react3.default.createElement(
            _reactBootstrap.Button,
            { onClick: _this3.openResource },
      ...
      var props = {
        clonedValues: _lodash2.default.clone(selectedValue),
        clonedList: _lodash2.default.clone(this.state.list) || _lodash2.default.clone(field.list),
