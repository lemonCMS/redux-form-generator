...
var SelectType = _wrapComponent('SelectType')((_dec = (0, _Wrap2.default)(), _dec(_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(SelectType, _Component);

  function SelectType() {
    (0, _classCallCheck3.default)(this, SelectType);

    var _this = (0, _possibleConstructorReturn3.default)(this, (SelectType.__proto__ || (0, _getPrototypeOf2.default)(SelectType)).call(this));
  ...
  (0, _createClass3.default)(SelectType, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(
        ...
        (0, _extends3.default)({ componentClass: 'select', placeholder: _lodash2.default.get(this.props.field, 'placeholder', '')
