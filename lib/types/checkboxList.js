  ...
  (0, _createClass3.default)(CheckboxListType, [{
    ...
    value: function searchBox() {
      if (!!this.props.field.searchable && !this.props.static) {
        return _react3.default.createElement('input', { type: 'text', placeholder: 'search', initialValue: this.state.value, onKeyDown: this.handlePrevent, onKeyUp: this.handleChange, className: 'form-control' });
      }
    }
  }, {
    key: 'render',
