...
var DropDownType = _wrapComponent('DropDownType')((_temp = _class = function (_Component) {
    ...
    value: function dropDownSelect(name, item) {
      ...
      return new _promise2.default(function (resolve) {
        if (_lodash2.default.has(_this2.props, 'formKey')) {
          resolve(_this2.props.dispatch((0, _reduxForm.changeWithKey)(_this2.props.formName, _this2.props.formKey, name, item.field)));
        } else {
          resolve(_this2.props.dispatch((0, _reduxForm.change)(_this2.props.formName, name, item.field)));
        }
      }).then(function () {
    ...
    value: function dropDown() {
      ...
      _lodash2.default.map(this.props.field.items, function (item, key) {
        ...
        if (item.hasOwnProperty('default')) {
          ...
          if (_lodash2.default.get(_this3.props, ['properties', 'defaultValue']) === item.field) {
  ...
  'static': _react2.PropTypes.boolean
}, _temp));
