...
var FileType = _wrapComponent('FileType')((_temp = _class = function (_Component) {
  (0, _inherits3.default)(FileType, _Component);

  function FileType() {
    (0, _classCallCheck3.default)(this, FileType);
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(FileType).apply(this, arguments));
  }
  ...
  (0, _createClass3.default)(FileType, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(_reactBootstrap.Input, (0, _extends3.default)({
