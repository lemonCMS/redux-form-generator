...
var RadioType = (function (_Component) {
  ...
  RadioType.prototype.radioButtonWrite = function radioButtonWrite(name, option, selectedValue, key) {
  ...
  RadioType.prototype.radioButtonStatic = function radioButtonStatic(name, option, selectedValue, key) {
    return _react2['default'].createElement(
      'p',
