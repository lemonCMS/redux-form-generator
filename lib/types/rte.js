...
var InputType = (function (_Component) {
  ...
  InputType.prototype.handleEditorChange = function handleEditorChange(e) {
    ...
    if (_lodash2['default'].has(this.props, 'formKey')) {
      this.props.dispatch(_reduxForm.changeWithKey(this.props.formName, this.props.formKey, this.props.field.name, e.target.getContent()));
    } else {
      this.props.dispatch(_reduxForm.change(this.props.formName, this.props.field.name, e.target.getContent()));
    }
  };
