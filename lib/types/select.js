...
var SelectType = (function (_Component) {
  _inherits(SelectType, _Component);

  _createClass(SelectType, null, [{
    key: 'propTypes',
    value: {
  ...
  function SelectType() {
    _classCallCheck(this, _SelectType);
  ...
  SelectType.prototype.options = function options() {
  ...
  SelectType.prototype.getValue = function getValue() {
  ...
  SelectType.prototype.render = function render() {
  ...
  SelectType = _wrapComponent('_$SelectType')(SelectType) || SelectType;
  return SelectType;
})(_react.Component);
