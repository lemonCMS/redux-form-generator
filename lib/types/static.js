...
var StaticType = _wrapComponent('StaticType')((_temp = _class = function (_Component) {
  (0, _inherits3.default)(StaticType, _Component);

  function StaticType() {
    (0, _classCallCheck3.default)(this, StaticType);
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(StaticType).apply(this, arguments));
  }

  (0, _createClass3.default)(StaticType, [{
    key: 'render',
